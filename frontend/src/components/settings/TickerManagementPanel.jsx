    ...
    <div className="bg-white rounded-lg shadow">
      ...
      <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">종목 관리</h2>
            ...
            <div key={stock.ticker} className="p-4 hover:bg-gray-50 transition-colors">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 mb-1">{stock.ticker}</p>
                  <p className="text-xs text-gray-500">{stock.theme}</p>
                </div>
              </div>
