...
#### 핵심 인사이트 블록
- **투자 전략**: 단기/중기/장기 투자 의견 (비중확대/보유/관망/비중축소)
- **종합 추천**: 중기 전략 기반 종합 추천 및 코멘트
- **핵심 포인트**: 최대 3개의 핵심 포인트 (수익률, 변동성, 매매동향, 뉴스 기반)
- **리스크 요약**: 최대 3개의 주요 리스크 (변동성, 하락, 규제, 관세 등)
...
#### 벤치마크 대비 분석
- 코스피/코스닥/코스피200 대비 수익률 비교
- 초과수익률 (Alpha) 계산
- 상관계수 분석
- 기간별 분석 (1주, 1개월, 3개월, 6개월, 1년)
