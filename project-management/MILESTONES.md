...
- [x] 데이터베이스 스키마 생성
- [x] 기본 API 엔드포인트 구조
- [ ] 1개 ETF(480450) 데이터 수집 구현
- [ ] 가격 데이터 API 테스트
- [ ] 에러 핸들링 및 로깅

### 완료 조건 (Acceptance Criteria)
- ✅ API가 ETF 가격 데이터를 성공적으로 반환
- ✅ 데이터가 데이터베이스에 저장됨
- ✅ Swagger 문서 (`/docs`)가 접근 가능
- ✅ 최소 1개 ETF의 최근 30일 데이터 수집 완료
...
### 목표
전체 4개 ETF에 대한 완전한 데이터 수집 시스템 구축

### 체크리스트
- [ ] 나머지 3개 ETF 데이터 수집 구현
- [ ] 투자자별 매매 동향 데이터 수집
- [ ] 뉴스 스크래핑 구현
...
### 완료 조건
- ✅ 4개 ETF 모두 완전한 데이터 보유 (가격, 매매 동향, 뉴스)
...
**영향도**: High  
**대응**:
- 여러 데이터 소스 준비 (FinanceDataReader, 네이버, KRX)
